...
export default function Home() {
  return (
    <div className="flex items-center justify-center w-screen h-screen bg-gradient-to-r bg-slate-300 dark:bg-gray-950 ">
      <div>
        <h1 className="text-6xl mb-12 text-center dark:text-white">
          Chingiz Mammadov
        </h1>
        <div className="group w-10/12 mx-auto grid grid-cols-1 md:grid-cols-2 gap-3">
